	...
	if (self = [super init]) {
		...
		for (int i = 0; i < [names count]; i++) {
            ...
            [data setColors:@[
                              ...
                              [[VLMColorData alloc] initWithName:@"erase" RGBA:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:0.25f] PreMultipliedColor:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:1.0f] Label:(i!=[names count]-1) ? @"ERASE\n25":@"ERASE\n." Enabled:(i!=[names count]-1) Subtractive:YES TextColor:[UIColor blackColor]],
                              [[VLMColorData alloc] initWithName:@"erase" RGBA:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:0.5f] PreMultipliedColor:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:1.0f] Label:(i!=[names count]-1) ? @"50" : @"." Enabled:(i!=[names count]-1) Subtractive:YES TextColor:[UIColor blackColor]],
                              [[VLMColorData alloc] initWithName:@"erase" RGBA:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:0.75f] PreMultipliedColor:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:1.0f] Label:(i!=[names count]-1) ? @"75" : @"." Enabled:(i!=[names count]-1) Subtractive:YES TextColor:[UIColor blackColor]],
