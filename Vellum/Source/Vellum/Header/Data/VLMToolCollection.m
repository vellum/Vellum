		...
		for (int i = 0; i < [names count]; i++) {
            ...
            if (i==5){
                [data setColors:@[
                                  ...
                                  [[VLMColorData alloc] initWithName:@"erase" RGBA:[UIColor colorWithHue:0.0f/360.0f saturation:0.0f brightness:0.0f alpha:1.0f] PreMultipliedColor:[UIColor colorWithHue:70.0f/360.0f saturation:0.05f brightness:0.95f alpha:1.0f] Label:@"ERASE\n25" Enabled:NO Subtractive:NO TextColor:[UIColor blackColor]],
